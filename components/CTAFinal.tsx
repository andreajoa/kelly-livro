      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <div className="bg-white/70 backdrop-blur-md border border-white/20 rounded-2xl shadow-xl p-5 sm:p-8 mb-8 text-left max-w-md mx-auto">
          ...
          <div className="border-t mt-4 pt-4 text-center">
            <p className="text-gray-500 line-through text-xs">{currencySymbol} {t.oldPrice.toFixed(2)}</p>
            <p className="text-3xl sm:text-4xl font-playfair font-bold text-rosa-700 mt-1">{currencySymbol} {t.price.toFixed(2)}</p>
          </div>
        </div>
